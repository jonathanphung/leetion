/**
 * super-board QA — issue #11, popup-layer static server.
 *
 ...
 *   → http://localhost:8211/?seed=dated          entry with a review date
 *   → http://localhost:8211/?seed=empty          entry whose date is empty
 *   → http://localhost:8211/?seed=none           problem not in Notion yet
 *   → http://localhost:8211/?demo=clear&fail=1   forced Notion failure
 */
