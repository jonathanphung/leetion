/**
 * super-board QA — issue #10, popup-layer static server.
 *
 ...
 *   → http://localhost:8210/            intervals 1/3/7
 *   → http://localhost:8210/?intervals=0,0,0
 *   → http://localhost:8210/?fail=1     forced Notion failure
 */
